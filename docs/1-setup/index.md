...
- Do not include the terminal prompt (e.g., `[student@ansible-1 ~]$` or `$`)
- Run commands one at a time unless specified
...
If you need more information on new Ansible Automation Platform components bookmark this landing page [https://www.redhat.com/en/technologies/management/ansible](https://www.redhat.com/en/technologies/management/ansible)
...
* `pwd`: prints the current working directory's full path.
 ...
 ![terminal_cd_folder](images/vscode-terminal-cd-command.jpg)
